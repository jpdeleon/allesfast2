...
from allesfast.exoworlds_rdx.lightcurves.index_transits import get_first_epoch
from allesfast.exoworlds_rdx.lightcurves.lightcurve_tools import calc_phase
