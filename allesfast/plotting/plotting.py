...
#::: local imports
from allesfast.inout import read_csv
from allesfast.time_series import sigma_clip, slide_clip
...
def brokenplot(time, y, yerr=None, dt=10, clip=False, bax=None, **kwargs):
    ...
    if 'brokenaxes' not in sys.modules:
        raise ImportError('You must install the brokenaxes package before using allesfast.brokenplot()\n(pip install brokenaxes)')
