...
#::: my modules
import allesfast
from allesfast.lightcurves import eclipse_width_smart
from allesfast.exoworlds_rdx.lightcurves.index_transits import index_transits, get_tmid_observed_transits
from allesfast.plotting import fullplot, brokenplot, chunkplot, monthplot, tessplot
...
def prepare_ttv_fit(datadir, style='fullplot', max_transits=20):
    ...
    -------
    datadir : str
        the working directory for allesfast; must contain all the data files; output directories and files will also be created inside datadir
    style : str
    ...
    #::: setup
    #----------------------------------------------------------------------
    alles = allesfast.allesclass(datadir)
