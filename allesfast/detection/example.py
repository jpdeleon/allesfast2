...
#::: my modules
from allesfast import tessplot
from allesfast.time_series import sigma_clip, slide_clip, mask_regions
from allesfast.detection.periodicity import estimate_period
from allesfast.detection.transit_search import get_tls_kwargs_by_tic, tls_search
