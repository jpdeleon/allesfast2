...
###############################################################################
#::: Pre-initialise PyTransit models (call once after BASEMENT is loaded)
###############################################################################
...
#::: possible functions
###############################################################################  
GPs = ['sample_GP_real', 'sample_GP_complex', 'sample_GP_Matern32', 'sample_GP_SHO', 'sample_GP_custom']
FCTs = ['none', 'offset', 'linear', 'hybrid_offset', 'hybrid_poly_0', 'hybrid_poly_1', 'hybrid_poly_2', 'hybrid_poly_3', 'hybrid_poly_4', 'hybrid_poly_5', 'hybrid_poly_6', 'hybrid_spline', 'hybrid_spline_s', 'sample_offset', 'sample_linear', 'sample_quad']
...
#==============================================================================
#::: calculate baseline: sample_quad
#============================================================================== 
def baseline_sample_quad(*args):
    x, y, yerr_w, xx, params, inst, key = args
    xx_norm = (xx-x[0]) / (x[-1]-x[0])
    return params['baseline_quad_'+key+'_'+inst] * xx_norm**2 + params['baseline_slope_'+key+'_'+inst] * xx_norm + params['baseline_offset_'+key+'_'+inst]
...
def baseline_get_gp(params, inst, key):
    ...
    elif config.BASEMENT.settings['baseline_'+key+'_'+inst] =='sample_GP_custom':
        kernel = CustomTerm(log_B=params['baseline_gp_custom_lnB_'+key+'_'+inst],
                            log_C=params['baseline_gp_custom_lnC_'+key+'_'+inst],
...
baseline_switch = \
    ...
    'sample_quad' : baseline_sample_quad,
    'sample_GP_custom' : baseline_sample_GP,
...
def stellar_var_get_gp(params, key):
    ...
    elif config.BASEMENT.settings['stellar_var_'+key] == 'sample_GP_custom':
        kernel = CustomTerm(log_B=params['stellar_var_gp_custom_lnB_'+key],
                            log_C=params['stellar_var_gp_custom_lnC_'+key],
...
stellar_var_switch = \
    ...
    'sample_GP_custom'       : stellar_var_sample_GP,
